void generator(struct site *a_site) {
	...
	char* contentArray[21] = {"Amphibians include frogs, toads, and salamanders. They have moist, smooth skin and are cold-blooded. Amphibians start life as aquatic larvae, but undergo metamorphosis to become land-dwelling adults. Frogs and toads lose their tails in this metamorphosis, but salamanders do not.",
							  ...
							  "Bush Master's can be found in the rainforests of Central and South America. They can also be found on the forest floors of Colombia, East Ecuador, Brazil, Venezuela, Surinam, French Guiana, Guyana, Trinidad, NE/E Peru, and North Bolivia. They eat mostly smaller mammals. Their enemies are larger birds of prey, especially when they are young.",
