...
int o_size = 30; // This is the number of sites in the array of sites.
                // Change this number when you change the number of
                // sites to be reordered

/* This function takes a pointer the array of sites and assigns the order
   field of each site a number based on its fitness field.  Thus, the
